...
unk = unk.reshape(num_bands, 2, unk.shape[1]//2)
unk2 = unk2.reshape(num_bands, 2, unk2.shape[1]//2)
unk3 = unk3.reshape(num_bands, 2, unk3.shape[1]//2)
unk4 = unk4.reshape(num_bands, 2, unk4.shape[1]//2)
unk5 = unk5.reshape(num_bands, 2, unk5.shape[1]//2)
...
print(dotprod(c_kb[0,0], c_kb[0,0]), np.sum(np.abs(c_kb[0,0])**2))
print(dotprod(c_kb[1,30], c_kb[1,30]))
...
for i in range(24, 28):
	...
	swich_xy_berry = 0j
	swich_yx_berry = 0j
	for n in range(90): # can change this value
